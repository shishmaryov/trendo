...
$(document).ready(function(){
	$('.faq__question--1').click(function(){
		$('.faq__open--1').addClass('faq__open-1--active'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--1').click(function(){
		$('.faq__open-1--active').toggleClass('faq__open--close'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--2').click(function(){
		$('.faq__open--2').addClass('faq__open-2--active'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--2').click(function(){
		$('.faq__open-2--active').toggleClass('faq__open--close'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--3').click(function(){
		$('.faq__open--3').addClass('faq__open-3--active'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--3').click(function(){
		$('.faq__open-3--active').toggleClass('faq__open--close'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--4').click(function(){
		$('.faq__open--4').addClass('faq__open-4--active'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--4').click(function(){
		$('.faq__open-4--active').toggleClass('faq__open--close'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--5').click(function(){
		$('.faq__open--5').addClass('faq__open-5--active'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--5').click(function(){
		$('.faq__open-5--active').toggleClass('faq__open--close'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--6').click(function(){
		$('.faq__open--6').addClass('faq__open-6--active'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--6').click(function(){
		$('.faq__open-6--active').toggleClass('faq__open--close'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--7').click(function(){
		$('.faq__open--7').addClass('faq__open-7--active'); return false;
	});
});

$(document).ready(function(){
	$('.faq__question--7').click(function(){
		$('.faq__open-7--active').toggleClass('faq__open--close'); return false;
	});
});
